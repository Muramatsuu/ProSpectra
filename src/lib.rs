...
#[derive(Debug)]
pub struct ProSpectraProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ProSpectraProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ProSpectra processing");
    
    let mut processor = ProSpectraProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ProSpectraProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ProSpectraProcessor::new(false);
